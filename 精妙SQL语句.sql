...
o	从数据库中去一年的各单位电话费统计(电话费定额贺电化肥清单两个表来源） 
SELECT a.userper
, a.tel
, a.standfee
...
o	获取表结构[把 'sysobjects' 替换 成 'tablename' 即可] 
